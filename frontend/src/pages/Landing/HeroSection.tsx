  ...
  return (
    <section className="relative bg-white pt-20 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-primary-50/80 via-white to-accent-50/60"></div>
        ...
        <motion.div
          ...
          className="absolute top-1/4 right-1/4 w-32 h-32 bg-primary-300/20 rounded-full blur-2xl"
        />
        <motion.div
          animate={{ y: [0, 40, 0], x: [0, -20, 0] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-1/3 left-1/3 w-40 h-40 bg-accent-300/20 rounded-full blur-2xl"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <div className="absolute -inset-1 bg-gradient-to-r from-primary-500 to-accent-500 rounded-3xl blur-xl opacity-30"></div>
              
              <div className="relative aspect-[4/5] bg-gradient-to-br from-primary-100 via-white to-accent-100 overflow-hidden">
                {/* Background Image */}
                <img 
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-large p-6 max-w-xs border border-neutral-100 cursor-pointer"
            >
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <div className="font-bold text-neutral-900 mb-1">Đặt lịch thành công!</div>
                  <div className="text-sm text-neutral-600">Chúng tôi sẽ liên hệ xác nhận trong 15 phút</div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.05, rotate: -2 }}
              className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-large p-4 border border-neutral-100 cursor-pointer"
            >
